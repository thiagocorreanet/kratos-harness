...
import { relayClaudeCodePreToolUse } from "../runtime/source/packages/adapters/src/claude-code/pre-tool-use.js";
...
const result = relayClaudeCodePreToolUse(input, execute);
