...
Task 1: fix round 1/5 (3 addressed, 0 open; commits f577cb0..cb2dace)
...
Task 1: complete (commits ebbced0..cb2dace, review clean with 1 deferred minor)
...
Task 2: fix round 1/5 (3 addressed, 0 open; commits 4778384..98fcad0)
...
Task 2: complete (commits cb2dace..98fcad0, review clean)

Task 3: fix round 1/5 (4 addressed, 0 open; commits 7f2eba4..eac27a5): preserved migration-required diagnostics, compared exact raw profile bytes, covered every valid relay value shape in package verification, and corrected proof attribution.
Task 3: complete (commits 98fcad0..eac27a5, scoped re-review clean)

Task 4: complete (commit 836712b; full verify exit 0, task review clean)

Final review: fix wave 1/1 (6 addressed, 0 open; implementation commit c24fa1e): bound reinit profile reads to exact config write preconditions; preserved v1.1 roles/hosts in profile-only migration; escaped controls in stack evidence; rendered all profile leaves in migration preview; total-ordered stack evidence; pointed invalid-config doctor evidence at config.
Final review: complete (implementation commit c24fa1e; exact `npx --yes npm@11.16.0 run verify` exit 0 with 179 files / 4,736 tests).
