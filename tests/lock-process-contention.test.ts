...
describe("lock admission under real process contention", () => {
  it(
    ...
    async () => {
      ...
      // Bounded admission re-election is allowed to refuse exhausted rounds,
      // but the campaign must demonstrate that contention still makes
      // progress and never weakens mutual exclusion.
      expect(
