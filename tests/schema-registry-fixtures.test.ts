...
import initAnswersV1_6 from "../fixtures/contracts/v1.6/init-answers.json" with { type: "json" };
...
import projectConfigV1_5 from "../fixtures/contracts/v1.5/project-config.json" with { type: "json" };
