  ...
  it("keeps the complete implemented help byte-stable", () => {
    expect(renderHelp(DEFAULT_REGISTRY)).toBe(
      [
        ...
        "  objective             Record the objective this project is working toward.",
        "      --replace         Replace a divergent active objective with this text.",
        "      --root <path>     Operate on the project rooted at this path.",
        "  version               Print the runtime version.",
        "",
        "Retired commands:",
        "  auto                  Retired: this name no longer selects the auto phase.",
        "  code                  Retired: this name no longer selects the code phase.",
        "  eval                  Retired: this name no longer selects the eval phase.",
        "  next                  Retired: this name no longer selects the next phase.",
        "  prd                   Retired: this name no longer selects the prd phase.",
        "  review                Retired: this name no longer selects the review phase.",
        "  run                   Retired: this name no longer selects the run phase.",
        "  spec                  Retired: this name no longer selects the spec phase.",
        "",
        "Global flags:",
