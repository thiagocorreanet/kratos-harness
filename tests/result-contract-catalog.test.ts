    ...
    const expected = new Map<string, { exitCode: number; recovery: string }>([
      [
        "brain_migration_pending",
        {
          exitCode: 1,
          recovery:
            "Run `kratos migrate brain` from the project root, verify the sibling Brain repository, and retry.",
        },
      ],
      [
        "gate.aceitacao_final",
        {
          exitCode: 3,
          recovery:
            "Review the final evidence and run `kratos done` to record explicit human acceptance.",
        },
      ],
      [
        "trail.use_done",
        {
          exitCode: 3,
          recovery:
            "Run `kratos done` instead of `kratos continue` for final acceptance.",
        },
      ],
      [
