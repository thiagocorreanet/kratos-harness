  ...
  it("renders a recognized root byte for byte without inventing profile values", () => {
    ...
    expect(profile).toBe(
      [
        ...
        "| Command | Value |",
        "| --- | --- |",
        "| Test | `<UNRESOLVED: projectProfile.commands.test>` |",
        "| Lint | `<UNRESOLVED: projectProfile.commands.lint>` |",
        "| Build | `<UNRESOLVED: projectProfile.commands.build>` |",
        "| Run | `<UNRESOLVED: projectProfile.commands.run>` |",
        "",
        "## Paths",
        "",
        "| Path group | Value |",
  ...
  it("renders a multi-stack root and every profile leaf byte for byte", () => {
    ...
    expect(profile).toBe(
      [
        ...
        "| --- | --- |",
        "| Test | `npm test` |",
        "| Lint | `npm run lint &#124; tee lint.log` |",
