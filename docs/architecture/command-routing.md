...
The registry currently contains `handshake`, `help`, `hook`, `init`,
`objective`, `start`, `continue`, and
...
a phase directly. Kratos v3 drives one agent trail and the runtime selects
